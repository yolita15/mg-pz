...
<body>
        ...
        <!-- slider -->
        <!--JS-->
        <script type="text/javascript" src="{{ url('http://ajax.googleapis.com/ajax/libs/jquery/1.7.0/jquery.min.js') }}"></script>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="panel panel-default">
                        ...
                        <a href="{{ url('https://docs.google.com/forms/d/1fpkJ1ndBO4YmyAk2UEfFYcR7m0HvAG-xH-dbolGtyE0/viewform') }}" target="new"><span class="glyphicon glyphicon-leaf"></span> АНКЕТА – НАШИЯТ ЕКОЛОГИЧЕН ОТПЕЧАТЪК</a>
                         към проект Reflect the Facts to Act.
                    
                    <br> 
                    <br>
                        <a href=" {{ url('https://docs.google.com/forms/d/1wuH3PC8Bl4YqZUwv_bYRMUC6QpV_JoZJnhDIEd3HtQk/viewform') }}" target="new"><span class="glyphicon glyphicon-zoom-in"></span> Анкета</a>
                ...
                <div class="col-md-6">
                    <div class="panel panel-danger">
                      ...
                      <div class="panel-body"><b>18.05.2016 г.</b> – ДЗИ по български език и литература и НВО в VII клас по български език и литература
                        <br>
                        <br>
                        <b>20.05.2016 г.</b> – Втори ДЗИ и НВО в VII клас по математика
                        <br>
                        <br>
                        Повече информация може да намерите на официалния сайт на <a href="{{ url('http://www.mon.bg/?') }}" target="new">МОН.</a>
                      </div>
                    </div>
                </div>
            </div>
