...
<header>
    ...
    <div id="header">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xs-1">
                    <a href="{{ url('/') }}"><img src="{{ url('images/logo.png') }}" class="img-responsive"
                                                  alt="MG K. Velichkov" id="logo"></a>
                </div>
    ...
    <nav class="navbar navbar-inverse" id="nav-bar">
        ...
        <div class="collapse navbar-collapse" id="mob-menu">
            <ul class="nav navbar-nav">
                <li class="{{ set_active(['/']) }}"><a href="{{ url('/') }}">Начало</a></li>
